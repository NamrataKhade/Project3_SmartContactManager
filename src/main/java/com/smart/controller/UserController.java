...
public class UserController {
	...
	public String processContact(@ModelAttribute Contact contact,
		...
		this.userRepository.save(user);//Save in database
		
		System.out.println("DATA "+contact);
		
		System.out.println("Add to database Succesfully !!!");
	...
	public String showContacts(@PathVariable("page") Integer page,Model model,Principal principal) {
		...
		/*//Principal principal
		 * //send contact list String userName = principal.getName(); User user =
	...
	public String showContactDetatils(@PathVariable("cId") Integer cId,Model model,Principal principal)
	{
	...
	public String createOrder(@RequestBody Map<String, Object> data,Principal principal) throws Exception
	{
		...
		var client=new RazorpayClient("rzp_test_YlKKqXxbLhFmqd", "Rfk9eN5DSbkkiyU5S9e7t5QL");
